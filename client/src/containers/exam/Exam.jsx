...
const Exam = ({
	examName = 'Periodic Test - DBMS: 13th Feburary, 2022',
	studentID = '2003133',
	studentEmail = 'piushpaul.16@gmail.com',
	duration = 60,
	...
	function check() {
		...
		if (!isFullScreen) {
			...
			setShowMessage(
				'Your exam will terminate.1) Please go to full screen mode, press F11 to enter full screen mode. 2) Ensure you are facing on the screen.'
			);
			disableForm();
		} else {
			enableForm();
